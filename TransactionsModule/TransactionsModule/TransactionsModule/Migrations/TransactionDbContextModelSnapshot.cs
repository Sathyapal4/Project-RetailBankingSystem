            ...
            modelBuilder.Entity("TransactionsModule.Models.Services", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Service_ID = 1,
                            Date_Service_Provided = new DateTime(2021, 6, 8, 20, 5, 33, 485, DateTimeKind.Local).AddTicks(3680),
                            Other_Details = "Other Details 1"
                        },
                        new
                        {
                            Service_ID = 2,
                            Date_Service_Provided = new DateTime(2021, 6, 8, 20, 5, 33, 485, DateTimeKind.Local).AddTicks(4469),
                            Other_Details = "Other Details 1"
                        },
                        new
                        {
                            Service_ID = 3,
                            Date_Service_Provided = new DateTime(2021, 6, 8, 20, 5, 33, 485, DateTimeKind.Local).AddTicks(4483),
                            Other_Details = "Other Details 1"
                        });
                });
